...
// Header
const Header: React.FC<{ onSubmit: (e: React.FormEvent) => void }> = ({ onSubmit }) => (
...
// Search
const Search: React.FC<{ onSubmit: (e: React.FormEvent) => void }> = ({ onSubmit }) => (
...
const UserProfile: React.FC = () => (
    <div className="UserProfile">
        <div className="User">
            <div className="name">Miri</div>
            <div className="image">
                <img src="/mspotato.jpeg" alt="Profile" />
            </div>
        </div>
    </div>
)
...
const Hero: React.FC = () => (
    <div id="hero" className="Hero" style={{ backgroundImage: "url(https://images.alphacoders.com/633/633643.jpg)" }}>
        <div className="content">
            <Image className="logo" src="/mirita.png" alt="Mirita" width="180" height="100" />
            <h2>Season 22 now available</h2>
            <p>Terminando la season 21 en un sitio que jamás podía faltar</p>
        ...
        <div className="content">
            <div className="container">
                <img src="/mspotato.jpeg" alt="content" width="300" />
            </div>
        </div>
    </div>
)
...
// Hero Button
const HeroButton: React.FC<{ primary: boolean; text: string }> = ({ primary, text }) => (
    <a
        href="http://track.emirates.email/track/click/30705682/www.emirates.com?p="
        className="Button"
